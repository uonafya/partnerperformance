                ...
                <div class="panel-body" id="user_guide">
                    <form action="{{ url('download/surge') }}" method="post" class="form-horizontal">
                        ...
                        <p style="font-size: 16;">
                            After downloading, do not delete the first 6 columns. They are necessary for the system when you
                            upload the excel. You can delete any of the other columns if you do not wish to upload its data.
                            You can also delete any row other that the first row that is used as column headers.
                        </p>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Modality (You can select multiple modalities)
                                <b>(Required)</b> </label>
