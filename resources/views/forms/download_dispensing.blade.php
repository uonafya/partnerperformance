        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body" id="user_guide">
                    <form action="{{ url('download/dispensing') }}" method="post" class="form-horizontal">
                        @csrf

                        <p style="font-size: 16;">
                            After downloading, do not delete any column. They are necessary for the system when you upload
                            the excel. You can delete any row other that the first row that is used as column headers.
                        </p>
                    ...
                    <option value="2021" selected>21</option> -->
                            </select>
                        </div>
