...
<head>
    ...
    <title> Partner Perfomance | Dashboard </title>
</head>
    ...
    <div class="navbar navbar-default">
      ...
      -->
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a
                            href="https://partnermanagementsystem.uonbi.ac.ke/api/apps/Partner-Reporting-Dashboards/html/index.html">Home</a>
                    </li>
                    ...
                    @auth
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="{{ url('/dispensing/download') }}">Download Multi-Month Dispensing
                                        Template</a></li>
                                ...
                                <li><a href="{{ url('/cervical_cancer/download') }}">Download Cervical Cancer Template</a>
                                </li>
    ...
    $(function() {
        ...
        @empty($no_header)
            ...
            $("select").change(function() {
                ...
                var posting = $.post("{{ url('filter/any') }}", {
                    'session_var': id,
                    'value': em
                });
