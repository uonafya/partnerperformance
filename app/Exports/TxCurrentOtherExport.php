...
class TxCurrentOtherExport extends BaseExport
{
	protected $month;
    ...
    function __construct($request)
    {
		...
		name AS `Facility`, SUM(value) AS `Value`";
	}

    public function headings() : array
    {
		return ['County', 'Subcounty', 'Financial Year', 'Calendar Year', 'Month', 'Month Name', 'MFL Code', 'Facility', 'TX Curr'];
