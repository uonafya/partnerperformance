...
class QuarterlyHfrSubmissionExport implements FromArray, Responsable, WithHeadings, ShouldAutoSize
{
    ...
    function __construct($request)
    {
		...
		$sql = "week_number,name, facility_uid,facility_code, mech_id, partnername, country, countyname";

		$excel_headings = ["HFR Month/Week Start Date", "Week Number",'Facility or Community Name', 'Facility OR Community UID', 'Facility MFL code','Mechanism ID', 'Mechanism or Partner Name', 'OU', 'PSNU', ];
